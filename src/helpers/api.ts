...
export const getSingleGame = (id: string | number) => axios(`${baseUrl}games/${id}?key=${key}`);

export const getScreenshots = (id: string | number) => axios(`${baseUrl}games/${id}/screenshots?key=${key}`);
